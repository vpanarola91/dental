                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="survey_title" id="survey_title" placeholder="Enter Survey title" class="form-control" 
                                       value="<?php echo $survey_data['name']; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <textarea name="survey_description" id="survey_description" placeholder="Enter Survey Description"
                                          class="summernote form-control"><?php echo $survey_data['survey_desc']; ?></textarea>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $('input[name=status][value=<?php echo $survey_data["status"]; ?>]').attr('checked',true);
